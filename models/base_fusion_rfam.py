...
class RFAMNET(nn.Module):
    ...
    def forward(self, rgb, low, high):
        ...
        cat2 = torch.cat([up2, self.rfam1(low3, high3, rgb3)], dim=1)
        ...
        cat3 = torch.cat([up3, self.rfam2(low1, high1, rgb1)], dim=1)
...
if __name__ == '__main__':
    model = RFAMNET(2, 'resnet50', False, False, multi_grid=True, multi_dilation=[4, 8, 16]).cuda()
